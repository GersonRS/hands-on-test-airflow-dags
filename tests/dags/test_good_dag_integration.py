...
from dags.src.hugging_face_functions import get_sentiment_score
...
def test_get_sentiment_score_is_reasonably_sure_for_clearly_positive_feedback_roberta():
    ...
    assert sentiment_score > 0.9, "The sentiment score for clear positive feedback should be high."
...
def test_get_sentiment_score_is_reasonably_sure_for_clearly_negative_feedback_roberta():
    ...
    assert sentiment_score > 0.9, "The sentiment score for clear negative feedback should be low."
