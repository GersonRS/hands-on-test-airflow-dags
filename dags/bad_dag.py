...
def bad_dag():
    ...
    def task1(**context):
        ...
        df2 = pd.read_csv("include/data_generation/data/ingest/customer_data/customer_data3.csv")
        ...
        for comment in list_of_comments:
            ...
            list_of_sentiments.append({"comment": comment, "sentiment_score": sentiment_score})

        print(f"The comment {comment} has a sentiment score of {sentiment_score}")

        print(df2)

        df3 = pd.read_csv("include/data_generation/data/ingest/sales_reports/sales_reports3.csv")
        ...
        print(f"The average number of purchases per toy is {df3['QuantitySold'].mean()}")
